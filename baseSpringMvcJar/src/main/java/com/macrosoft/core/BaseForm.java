 ...
 * @author 呆呆
 */
public class BaseForm extends BaseEntity implements Serializable {
	...
	public String getPageSize() {
		...
		if (StringUtils.isEmpty(pageSize) == true
			...
			pageSize = Long.toString(CommonConst.SYS_DEFAULT_PAGESIE);
			pageSizeInt = CommonConst.SYS_DEFAULT_PAGESIE;
		} else {
			try {
				...
				pageSizeInt = CommonConst.SYS_DEFAULT_PAGESIE;
				ex.printStackTrace();
				LoggerUtils.logger.error(ex, ex);
			}
		}
		return pageSize;
	}
	...
	public String getPageNo() {
		if (StringUtils.isEmpty(pageNo) == true || "0".equals(pageNo) == true
				|| "null".equals(pageNo) == true) {
			pageNo = "1";
		}
		try {
